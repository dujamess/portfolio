function Skills()
{
    return(
        <div className="w-[52%]">
            ...
            <div className=" border-[0.05vw] border-move1 bg-move rounded-[1vw] flex pt-4 pb-4">
            ...
            <div className="flex  mt-7 space-x-4" >
                <div className=" w-[149px] bg-move  border-move1 font-normal rounded-[1vw] text-[#C5C7BC] font-inter text-[11px] border-[0.05vw] flex flex-col p-3 space-y-2 ">
                    <p>-  Javascript</p>
                    <p>-  C</p>
                    <p>-  C++</p>
                </div>
                <div className="w-[149px] bg-move border-move1 rounded-[1vw] text-[#C5C7BC] font-inter text-[11px] border-[0.05vw] p-3 font-normal flex flex-col space-y-2 ">
                    <p>-  React js</p>
                    <p>-  Fastify js</p>
                </div>
                <div className="bg-move border-move1 rounded-[1vw] text-[#C5C7BC]  font-inter text-[11px] border-[0.05vw] p-3 font-normal flex flex-col space-y-2 ">
                    <p>-  SQLite</p>
                    <p>-  MariaDB</p>
                    <p>-  PostgreSQL</p>
                </div>
