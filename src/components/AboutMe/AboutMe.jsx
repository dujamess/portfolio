...
{
    return (
          <div className="w-[746px] h-[234px] bg-move2 rounded-[10px] mt-[100px]">
            <div className="flex p-4 space-x-2">
                <img src="icon-about.svg" alt="icon-about-me"></img>
                <p className="font-inter font-medium text-[16px] text-hlibi">About-me</p>
            </div>
            <div className="flex">
                <p className="font-inter font-light text-[11px] text-hlibi p-4">     Hello, I'm khadija Messah.
                ...
                <img src="ptofile1.svg" alt="ptofile" className=" pr-7 pb-11"></img>
            </div>
        </div>
    )
}