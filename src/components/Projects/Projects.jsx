      ...
      <div className="w-[746px]">
          ...
          <div className="flex-col">
              ...
              <div className="flex justify-around mt-8">
                ...
                <div className="flex-col space-y-2">
                    <div className="w-[205px]  bg-move border-[0.5px] border-move1 rounded-t-[10px]">
                      <img src="/2DSprite.svg" alt="2DSprite"></img>
              ...
              <div className="flex justify-around mt-8">
                  <div className="flex-col space-y-2">
                    ...
                    <div className="w-[205px]  bg-move border-[0.5px]  border-move1 rounded-b-[10px] flex justify-center">
                      <img src="/icon-link.svg" alt="icon-link"></img>
                      <a href="https://www.khadija-messah.me/Smart_City.mp4" target="_blank" className="font-inter font-medium text-[12px] text-[#DEDED1] p-1">SmartCity</a>
                    </div>
                  </div>
                  <div className="flex-col space-y-2">
                    <div className="w-[205px]  bg-move border-[0.5px]  border-move1 rounded-t-[10px]">
                    ...
                    <div className="w-[205px]  bg-move border-[0.5px]  border-move1 rounded-b-[10px] flex justify-center">
                      <img src="/icon-link.svg" alt="icon-link"></img>
                      <a href="https://www.khadija-messah.me/smarcity_project.pdf" target="_blank" className="font-inter font-medium text-[12px] text-[#DEDED1] p-1">PDF-SmartCity</a>
                    </div>
                  </div>
                  <div className="flex-col space-y-2">
                    <div className="w-[205px]  bg-move border-[0.5px]  border-move1 rounded-t-[10px]">
                    ...
                    <div className="w-[205px]  bg-move border-[0.5px]  border-move1 rounded-b-[10px] flex justify-center">
                      <img src="/icon-link.svg" alt="icon-link"></img>
                      <a href="https://www.khadija-messah.me/pink-room.mp4" target="_blank" className="font-inter font-medium text-[12px] text-[#DEDED1] p-1">GamingRoom</a>
                    </div>
                  </div>
              </div>
          </div>
